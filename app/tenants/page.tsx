...
import Table from '../components/tenants/table'
import Grid from '@mui/material/Grid';
import { FETCH_TENANTS } from '../utils/queries';
...
export default function Page() {
  ...
  const [res] = useQuery({query: FETCH_TENANTS, variables: {search} });
